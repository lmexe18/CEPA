...
router.post('/', [
    check('titulo').isString().isLength({ min:2, max:50 }).notEmpty().withMessage('El título debe de ser texto'),
    check('noticia').isString().notEmpty().withMessage('El contenido de la noticia es obligatorio'),
    check('enlace').isString().isLength({ min: 3 }).notEmpty().withMessage('El enlace debe de ser un texto'),
...
router.put('/:id', [
    check('titulo').isString().isLength({ min:2, max:50 }).withMessage('El título debe de ser texto'),
    check('noticia').notEmpty().withMessage('El contenido de la noticia es obligatorio'),
    check('enlace').isString().isLength({ min: 3 }).withMessage('El enlace debe de ser un texto'),
